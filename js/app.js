...
const egresos=[
    new Egreso("Renta de apartamento",900.00),
...
//se encarga de actualizar el cabezero
let cargarCabecero =()=>{
    ...
    <div class="derecha limpiarEstilos">
        ...
        <div class="elemento_eliminar">
            <button class="elemento_eliminar--btn">
                <ion-icon name="trash-outline" onclick='eliminarIngreso(${ingreso.idIngreso})'></ion-icon>
            </button>
        </div>
    </div>
</div>
...
let agregarDato =()=>{
    ...
    if(descripcion.value !== "" && valor.value !==""){
        if(tipo.value === "ingreso"){
            //+valor.value = se convierte en entero
            //Number(valor.value)
